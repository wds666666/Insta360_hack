...
画面是这一间房的 3D 屋剖面：斜俯视，一个角度。只留左、右、后三面墙，朝向镜头的一面切开，不要第四面墙。不要天花板、不要屋顶，上方完全敞开。地面留一块厚板，和三面墙连成开口的盒子。不要把不同视角画成好几间房。
墙和地面是连在一起的厚实心板，厚度至少像两根手指并起来。不要纸一样的薄面片，不要没有厚度的单层壳，不要飘着的隔板和玻璃。
家具画成贴地的粗实心块，同样要有明显厚度。去掉床品褶皱、灯线、画框、植物、门把手和细桌腿，细过一根手指的东西不要出现。
最后交给 Lux3D 打印。表面平整，少纹理。严格依据照片里真实的墙、地面、门窗和主要家具，不要另造房间。`;
